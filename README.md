...
## Для того чтобы запустить проект нужно ввести команды
   #### git clone https://github.com/Tim-Elesh/Parser-Front-.git - клонирование репозитория на локальный компьютер.
   ...
   #### npm install -g serve - глобальная установка статического сервера serve для раздачи файлов.
   #### serve -s dist - запуск сервера serve для раздачи файлов из директории dist
